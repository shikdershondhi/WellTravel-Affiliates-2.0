...
Cypress.Commands.add('travelapp_hotel_traveler_selection_children', () => {
	...
	times(0, () => {
		cy.get(':nth-child(2) > .quantity-selector > :nth-child(3) > .quantity-selector__icon').click().wait(1000)
	})
	cy.get('.search-menu__container--travellers > .rcl-popover__parent > .search-menu__menu-label > .search-menu__menu-label--icon > .icon > svg').click().wait(2000)
})
...
Cypress.Commands.add('travelapp_hotel_location', () => {
	...
	cy.get('.location-search-input__input > .input > .input__field-holder > .input__field').type('London{enter}').wait(1000)
...
Cypress.Commands.add('travelapp_hotel_checkin', () => {
	...
	cy.get('body > main:nth-child(2) > div:nth-child(1) > div:nth-child(1) > div:nth-child(3) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(2) > div:nth-child(1) > div:nth-child(1) > div:nth-child(2) > div:nth-child(2) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(2) > div:nth-child(1) > div:nth-child(1) > div:nth-child(3) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > input:nth-child(1)').type('25 July 2022').wait(2000)
})
...
Cypress.Commands.add('travelapp_hotel_checkout', () => {
	...
	cy.get('body > main:nth-child(2) > div:nth-child(1) > div:nth-child(1) > div:nth-child(3) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(2) > div:nth-child(1) > div:nth-child(1) > div:nth-child(2) > div:nth-child(2) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(2) > div:nth-child(1) > div:nth-child(1) > div:nth-child(3) > div:nth-child(2) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > input:nth-child(1)').type('1 August 2022').wait(2000)
	cy.get('.hotel-form__specifier-container').click().wait(1000)
})
...
Cypress.Commands.add('travelapp_hotel_results', () => {
	cy.get(':nth-child(1) > .card--v2__wrapper > :nth-child(1) > .card__body-section > .hotel-result__wrapper > :nth-child(1) > .hotel-result__middle > .grid > .col-lg-4 > .col-xlg-5 > a > .button').click().wait(7000)
})
