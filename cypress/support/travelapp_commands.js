...
Cypress.Commands.add('travelapp_select_trip', () => {
...
Cypress.Commands.add('travelapp_select_travelers', () => {
	// select travelers
	times(0, () => {
...
Cypress.Commands.add('travelapp_origin_start', () => {
...
Cypress.Commands.add('travelapp_destination', () => {
...
Cypress.Commands.add('travelapp_start_date', () => {
...
Cypress.Commands.add('travelapp_Review_book_continue_to_order', () => {
	...
	cy.get('.public-orders-show__actions > .link > .link__content').click().wait(3000)
